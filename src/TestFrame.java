...
/* ###### TAG BORT kommentarna på de 2 följande raderna när ni skrivit era samlingar */
	...
	*/
	...
	public static void testSLC(){
		...
		slc.add(new SpecialString("b"));
		slc.add(new SpecialString("c"));
		slc.add(new SpecialString("d"));

		System.out.println(slc.toString().equals("[a, b, c, d]"));
		...
		slc.clear();
		slc.add(new SpecialString("da"));
		slc.add(new SpecialString("c"));
		slc.add(new SpecialString("a"));
		slc.add(new SpecialString("ab"));
		slc.add(new SpecialString("deg"));

		System.out.println(slc.toString().equals("[a, ab, c, da, deg]"));

		// Get just keeps spinning, never terminating
		slc.add(new SpecialString("f"));

		System.out.println(slc.get(new SpecialString("ab")));
		System.out.println(slc.get(new SpecialString("a")));
		System.out.println(slc.get(new SpecialString("c")));
		System.out.println(slc.get(new SpecialString("deg")));
		System.out.println(slc.get(new SpecialString("da")));
		System.out.println(slc.get(new SpecialString("e")));
...
class SpecialString implements Comparable<SpecialString> {
	...
	@Override
	public int compareTo(SpecialString o) {
		return s.substring(0, 1).compareTo(o.s.substring(0, 1));
	}
